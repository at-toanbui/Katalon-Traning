...
WebUI.waitForElementVisible(findTestObject('Lesson 4/Page_Login - My Store/errormessage'), 10)

WebUI.verifyElementText(findTestObject('Lesson 4/Page_Login - My Store/txt_An email address required'), errormessage)
