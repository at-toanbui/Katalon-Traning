...
WebUI.waitForElementVisible(findTestObject('HungPhungK_Day4_Practice1/Page_Login - My Store/welcomeMsg'), GlobalVariable.TIMEOUT)

WebUI.verifyElementText(findTestObject('HungPhungK_Day4_Practice1/Page_Login - My Store/welcomeMsg'), loginsuccessmessage)
