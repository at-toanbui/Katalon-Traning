...
WebUI.click(findTestObject('lession2/HanhNguyenT_Day2_EX-08/Page_Selenium Easy Demo - Automate All Scenarios/btnClickPromptBox'))
...
result = WebUI.getText(findTestObject('lession2/HanhNguyenT_Day2_EX-08/Page_Selenium Easy Demo - Automate All Scenarios/lbResult'))
